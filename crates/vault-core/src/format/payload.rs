...
impl Payload {
    ...
    /// full outer plaintext in one buffer (security-gap review P3).
    ...
    /// ever holding the full decrypted plaintext in one contiguous buffer (security-gap review P3 / C19).
